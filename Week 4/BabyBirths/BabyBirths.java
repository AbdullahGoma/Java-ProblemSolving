...
public class BabyBirths {
	...
	public static void numOfNames (FileResource fr) {
		int total = 0;
		int totalBoys = 0;
		int totalGirls = 0;
		for (CSVRecord rec : fr.getCSVParser(false)) {
		...
		System.out.println("The number of girls names: " + totalGirls);
		System.out.println("The number of boys names: " + totalBoys);
	}
	...
	public static void testNumOfNames () {
		//FileResource fr = new FileResource();
		FileResource fr = new FileResource("babynamedata/us_babynames_by_year/yob1900.csv");
		numOfNames(fr);
	}
